  ...
  try {
    ...
    switch (true) {
      ...
      case photo && photo.size > 1000000:
        return res
          .status(500)
          .send({ error: "Photo is Required & shpuld be less than 1mb" });
    }
...
export const productListController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Error while count product per page",
      error,
    });
  }
};
...
//Related Product
export const relatedProductCaregory = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Successfully get all related product",
      products,
    });
  } catch (error) {
    console.log(error);
...
export const productCategoryController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Successfully getting product by categoryd",
      category,
      products,
    });
  } catch (error) {
...
export const braintreeTokenController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something went wrong while braintree token generate",
      error,
    });
  }
};
